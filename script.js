...
<tr>
<td>Base Cost</td>
<td>₹${data.baseCost.toFixed(0)}</td>
</tr>

<tr>
<td>Cement</td>
<td>₹${data.cementCost.toFixed(0)}</td>
</tr>

<tr>
<td>Sand</td>
<td>₹${data.sandCost.toFixed(0)}</td>
</tr>

<tr>
<td>Aggregate</td>
<td>₹${data.aggregateCost.toFixed(0)}</td>
</tr>

<tr>
<td>Steel</td>
<td>₹${data.steelCost.toFixed(0)}</td>
</tr>

<tr>
<td>Bitumen</td>
<td>₹${data.bitumenCost.toFixed(0)}</td>
</tr>

<tr>
<td>Material Total</td>
<td>₹${data.materialCost.toFixed(0)}</td>
</tr>

<tr>
<td>Labour Total</td>
<td>₹${data.labourCost.toFixed(0)}</td>
</tr>

<tr>
<td>Additional Works</td>
<td>₹${data.additionalCost.toFixed(0)}</td>
</tr>

<tr>
<td>Equipment & Overheads</td>
<td>₹${data.equipment.toFixed(0)}</td>
</tr>

<tr>
<td>GST</td>
<td>₹${data.gst.toFixed(0)}</td>
</tr>

<tr>
<td><b>Final Cost</b></td>
<td><b>₹${data.finalCost.toFixed(0)}</b></td>
</tr>

<tr>
<td>Cut-down Cost</td>
<td>₹${data.cutDown.toFixed(0)}</td>
</tr>
